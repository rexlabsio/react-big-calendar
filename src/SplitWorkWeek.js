...
class SplitWorkWeek extends React.Component {
  static displayName = 'SplitWorkWeek'
  static propTypes = propTypes

  static range = (date, options) => {
    return SplitWeek.range(date, options).filter(
  ...
  static title = (date, { localizer }) => {
    let [start, ...rest] = SplitWorkWeek.range(date, { localizer })
  ...
  render() {
    ...
    const range = SplitWorkWeek.range(date, this.props)
